...
public class DemandTest {
    ...
    @Test
    public void testItemDBRef() {
        Item item = new Item();
        Demand demand = new Demand();
        demand.setItem(item);

        Assert.assertEquals(item, demand.getItem());
    }

    @Test
    public void testLocationDBRef() {
        Location location = new Location();
        Demand demand = new Demand();
        demand.setLocation(location);

        Assert.assertEquals(location, demand.getLocation());
    }
    ...
    public void testOrganizationDBRef() {
        ...
        Assert.assertEquals(organization, demand.getOrganization());
    }
}
