...
/*
    ...
    public void testCreateItem_WithNewItem_ShouldCreateItem() {
        // Arrange
        Item newItem = new Item("00001", "itemNameOne", "itemOneDesc", "ItemOneCategory", "itemOneType", true, 2000, true, true, true,"ORG001");

        when(organizationRepository.findById(anyString())).thenReturn(Optional.of(new Organization("ORG001", "TUPLE","Tuple@gmail.com", "tuple@123")));
        when(itemRepository.findByOrganizationId(anyString())).thenReturn(new ArrayList<>());
        ...
        // Assert
        assertNotNull(result);
        assertEquals("ORG001_00001", result.getItemId());
